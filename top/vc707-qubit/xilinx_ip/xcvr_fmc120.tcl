create_ip -name gtwizard -vendor xilinx.com -library ip -module_name xcvr_fmc120
set_property -dict {
    CONFIG.identical_val_tx_line_rate {10}
    CONFIG.gt0_val {false}
    CONFIG.gt20_val {true}
    CONFIG.gt20_val_tx_refclk {REFCLK0_Q6}
    CONFIG.gt21_val {true}
    CONFIG.gt21_val_tx_refclk {REFCLK0_Q6}
    CONFIG.gt22_val {true}
    CONFIG.gt22_val_tx_refclk {REFCLK0_Q6}
    CONFIG.gt23_val {true}
    CONFIG.gt23_val_tx_refclk {REFCLK0_Q6}
    CONFIG.gt24_val {true}
    CONFIG.gt24_val_tx_refclk {REFCLK0_Q6}
    CONFIG.gt25_val {true}
    CONFIG.gt25_val_tx_refclk {REFCLK0_Q6}
    CONFIG.gt26_val {true}
    CONFIG.gt26_val_tx_refclk {REFCLK0_Q6}
    CONFIG.gt27_val {true}
    CONFIG.gt27_val_tx_refclk {REFCLK0_Q6}
    CONFIG.identical_val_tx_reference_clock {500.000}
    ...
    CONFIG.gt16_val_tx_refclk {REFCLK1_Q4}
    CONFIG.gt16_val_rx_refclk {REFCLK1_Q4}
    CONFIG.gt17_val_tx_refclk {REFCLK1_Q4}
    CONFIG.gt17_val_rx_refclk {REFCLK1_Q4}
    CONFIG.gt18_val_tx_refclk {REFCLK1_Q4}
    CONFIG.gt18_val_rx_refclk {REFCLK1_Q4}
    CONFIG.gt19_val_tx_refclk {REFCLK1_Q4}
    CONFIG.gt19_val_rx_refclk {REFCLK1_Q4}
    CONFIG.gt20_val_rx_refclk {REFCLK0_Q6}
    CONFIG.gt21_val_rx_refclk {REFCLK0_Q6}
    CONFIG.gt22_val_rx_refclk {REFCLK0_Q6}
    CONFIG.gt23_val_rx_refclk {REFCLK0_Q6}
    CONFIG.gt24_val_rx_refclk {REFCLK0_Q6}
    CONFIG.gt25_val_rx_refclk {REFCLK0_Q6}
    CONFIG.gt26_val_rx_refclk {REFCLK0_Q6}
    CONFIG.gt27_val_rx_refclk {REFCLK0_Q6}
    CONFIG.identical_val_rx_reference_clock {500.000}
    CONFIG.gt0_val_tx_line_rate {10}
    CONFIG.gt0_val_tx_data_width {32}
    CONFIG.gt0_val_tx_int_datawidth {40}
    CONFIG.gt0_val_tx_reference_clock {500.000}
    CONFIG.gt0_val_rx_line_rate {10}
    CONFIG.gt0_val_rx_data_width {32}
    CONFIG.gt0_val_rx_int_datawidth {40}
    CONFIG.gt0_val_rx_reference_clock {500.000}
    CONFIG.gt0_val_qpll_fbdiv {20}
...
generate_target {instantiation_template} [get_files xcvr_fmc120.xci]
update_compile_order -fileset sources_1
generate_target all [get_files xcvr_fmc120.xci]
export_ip_user_files -of_objects [get_files xcvr_fmc120.xci] -no_script -force -quiet
create_ip_run [get_files -of_objects [get_fileset sources_1] xcvr_fmc120.xci]
