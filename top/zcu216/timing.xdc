...
create_clock -period 4.000 -name adc2_clk_clk_p [get_ports adc2_clk_clk_p]
...
set_false_path -from [get_pins {plps_0/inst/plpsboard/plsv/pltop/boardcfg/*xdomain/*/C}] -to [get_pins {plps_0/inst/plpsboard/plsv/pltop/boardcfg/*xdomain/*/D}]
