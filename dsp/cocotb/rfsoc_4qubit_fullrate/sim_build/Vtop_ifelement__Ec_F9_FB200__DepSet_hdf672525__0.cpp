...
VL_INLINE_OPT void Vtop_ifelement__Ec_F9_FB200___ico_sequent__TOP__dsp_sim_toplevel__DOT__dspmod__DOT__rdrvelem__BRA__7__KET____0(Vtop_ifelement__Ec_F9_FB200* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vtop__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vtop_ifelement__Ec_F9_FB200___ico_sequent__TOP__dsp_sim_toplevel__DOT__dspmod__DOT__rdrvelem__BRA__7__KET____0\n"); );
    // Body
...
VL_INLINE_OPT void Vtop_ifelement__Ec_F9_FB200___ico_sequent__TOP__dsp_sim_toplevel__DOT__dspmod__DOT__rdrvelem__BRA__7__KET____1(Vtop_ifelement__Ec_F9_FB200* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vtop__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vtop_ifelement__Ec_F9_FB200___ico_sequent__TOP__dsp_sim_toplevel__DOT__dspmod__DOT__rdrvelem__BRA__7__KET____1\n"); );
    // Body
...
VL_INLINE_OPT void Vtop_ifelement__Ec_F9_FB200___nba_sequent__TOP__dsp_sim_toplevel__DOT__dspmod__DOT__rdrvelem__BRA__7__KET____0(Vtop_ifelement__Ec_F9_FB200* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vtop__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vtop_ifelement__Ec_F9_FB200___nba_sequent__TOP__dsp_sim_toplevel__DOT__dspmod__DOT__rdrvelem__BRA__7__KET____0\n"); );
    // Init
...
VL_INLINE_OPT void Vtop_ifelement__Ec_F9_FB200___nba_sequent__TOP__dsp_sim_toplevel__DOT__dspmod__DOT__rdrvelem__BRA__7__KET____1(Vtop_ifelement__Ec_F9_FB200* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vtop__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vtop_ifelement__Ec_F9_FB200___nba_sequent__TOP__dsp_sim_toplevel__DOT__dspmod__DOT__rdrvelem__BRA__7__KET____1\n"); );
    // Body
    vlSelf->multiy_check[0U] = (0xffffU & vlSelf->multiy[0U]);
    vlSelf->multiy_check[1U] = (vlSelf->multiy[0U] 
                                >> 0x10U);
...
VL_INLINE_OPT void Vtop_ifelement__Ec_F9_FB200___nba_comb__TOP__dsp_sim_toplevel__DOT__dspmod__DOT__rdrvelem__BRA__7__KET____0(Vtop_ifelement__Ec_F9_FB200* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vtop__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vtop_ifelement__Ec_F9_FB200___nba_comb__TOP__dsp_sim_toplevel__DOT__dspmod__DOT__rdrvelem__BRA__7__KET____0\n"); );
    // Body
    vlSelf->busy = ((IData)(vlSelf->busy_r) | (IData)(vlSelf->cmdstb));
}

std::string VL_TO_STRING(const Vtop_ifelement__Ec_F9_FB200* obj) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vtop_ifelement__Ec_F9_FB200::VL_TO_STRING\n"); );
    // Body
