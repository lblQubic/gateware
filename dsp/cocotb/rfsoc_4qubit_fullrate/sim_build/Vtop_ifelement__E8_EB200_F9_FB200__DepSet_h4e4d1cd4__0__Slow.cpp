...
VL_ATTR_COLD void Vtop_ifelement__E8_EB200_F9_FB200___eval_static__TOP__dsp_sim_toplevel__DOT__dspmod__DOT__qdrvelem__BRA__7__KET__(Vtop_ifelement__E8_EB200_F9_FB200* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vtop__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vtop_ifelement__E8_EB200_F9_FB200___eval_static__TOP__dsp_sim_toplevel__DOT__dspmod__DOT__qdrvelem__BRA__7__KET__\n"); );
    // Body
    vlSelf->cmdstb_sr = 0U;
...
VL_ATTR_COLD void Vtop_ifelement__E8_EB200_F9_FB200___ctor_var_reset(Vtop_ifelement__E8_EB200_F9_FB200* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vtop__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vtop_ifelement__E8_EB200_F9_FB200___ctor_var_reset\n"); );
    // Body
    ...
    vlSelf->envstart = VL_RAND_RESET_I(8);
    vlSelf->envlength = VL_RAND_RESET_I(8);
