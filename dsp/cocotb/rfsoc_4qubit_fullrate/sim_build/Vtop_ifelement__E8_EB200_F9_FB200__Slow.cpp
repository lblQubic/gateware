...
VL_CTOR_IMP(Vtop_ifelement__E8_EB200_F9_FB200) {
    // Reset internal values
    // Reset structure values
    _ctor_var_reset();
}

void Vtop_ifelement__E8_EB200_F9_FB200::__Vconfigure(Vtop__Syms* vlSymsp, bool first) {
...
void Vtop_ifelement__E8_EB200_F9_FB200::_initial__TOP__dsp_sim_toplevel__DOT__dspmod__DOT__qdrvelem__BRA__2__KET____1(Vtop__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vtop_ifelement__E8_EB200_F9_FB200::_initial__TOP__dsp_sim_toplevel__DOT__dspmod__DOT__qdrvelem__BRA__2__KET____1\n"); );
...
void Vtop_ifelement__E8_EB200_F9_FB200::_settle__TOP__dsp_sim_toplevel__DOT__dspmod__DOT__qdrvelem__BRA__2__KET____4(Vtop__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vtop_ifelement__E8_EB200_F9_FB200::_settle__TOP__dsp_sim_toplevel__DOT__dspmod__DOT__qdrvelem__BRA__2__KET____4\n"); );
    Vtop* const __restrict vlTOPp VL_ATTR_UNUSED = vlSymsp->TOPp;
    // Body
    this->cw2 = this->cw_d4;
...
void Vtop_ifelement__E8_EB200_F9_FB200::_ctor_var_reset() {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vtop_ifelement__E8_EB200_F9_FB200::_ctor_var_reset\n"); );
    // Body
    ...
    envstart = VL_RAND_RESET_I(8);
    envlength = VL_RAND_RESET_I(8);
