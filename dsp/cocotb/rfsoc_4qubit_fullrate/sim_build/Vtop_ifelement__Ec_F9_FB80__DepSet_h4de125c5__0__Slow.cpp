...
VL_ATTR_COLD void Vtop_ifelement__Ec_F9_FB80___eval_static__TOP__dsp_sim_toplevel__DOT__dspmod__DOT__rdloelem__BRA__7__KET__(Vtop_ifelement__Ec_F9_FB80* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vtop__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vtop_ifelement__Ec_F9_FB80___eval_static__TOP__dsp_sim_toplevel__DOT__dspmod__DOT__rdloelem__BRA__7__KET__\n"); );
    // Body
    vlSelf->cmdstb_sr = 0U;
    ...
    vlSelf->mode = 0U;
    vlSelf->valid_r = 0U;
    vlSelf->multix_r = 0ULL;
    vlSelf->multiy_r = 0ULL;
    vlSelf->tcnt = 0U;
...
VL_ATTR_COLD void Vtop_ifelement__Ec_F9_FB80___ctor_var_reset(Vtop_ifelement__Ec_F9_FB80* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vtop__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vtop_ifelement__Ec_F9_FB80___ctor_var_reset\n"); );
    // Body
    ...
    vlSelf->multix = VL_RAND_RESET_Q(64);
    vlSelf->multiy = VL_RAND_RESET_Q(64);
    vlSelf->multix_r = VL_RAND_RESET_Q(64);
    vlSelf->multiy_r = VL_RAND_RESET_Q(64);
