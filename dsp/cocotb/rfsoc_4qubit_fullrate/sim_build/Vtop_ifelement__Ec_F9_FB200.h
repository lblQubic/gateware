...
#ifndef VERILATED_VTOP_IFELEMENT__EC_F9_FB200_H_
#define VERILATED_VTOP_IFELEMENT__EC_F9_FB200_H_  // guard
...
class alignas(VL_CACHE_LINE_BYTES) Vtop_ifelement__Ec_F9_FB200 final : public VerilatedModule {
  public:
    ...
    // CONSTRUCTORS
    Vtop_ifelement__Ec_F9_FB200(Vtop__Syms* symsp, const char* v__name);
    ~Vtop_ifelement__Ec_F9_FB200();
    VL_UNCOPYABLE(Vtop_ifelement__Ec_F9_FB200);
