...
wire signed [DS:0] res_0_V_write_assign_fu_1431_p2;
...
reg signed [DS:0] dataI;
reg signed[DS:0] dataQ;
...
assign dataI = data_V_read[DS:0];
assign dataQ = data_V_read[DS+DS+1:DS+1];
