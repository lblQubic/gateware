...
assign w0_0 = sdif.sdpara[16];
assign w0_1 = sdif.sdpara[17];
assign w0_2 = sdif.sdpara[18];
assign w0_3 = sdif.sdpara[19];
assign w1_0 = sdif.sdpara[20];
assign w1_1 = sdif.sdpara[21];
assign w1_2 = sdif.sdpara[22];
assign w1_3 = sdif.sdpara[23];
assign w2_0 = sdif.sdpara[24];
assign w2_1 = sdif.sdpara[25];
assign w2_2 = sdif.sdpara[26];
assign w2_3 = sdif.sdpara[27];
assign w3_0 = sdif.sdpara[28];
assign w3_1 = sdif.sdpara[29];
assign w3_2 = sdif.sdpara[30];
assign w3_3 = sdif.sdpara[31];
assign w4_0 = sdif.sdpara[32];
assign w4_1 = sdif.sdpara[33];
assign w4_2 = sdif.sdpara[34];
assign w4_3 = sdif.sdpara[35];
assign w5_0 = sdif.sdpara[36];
assign w5_1 = sdif.sdpara[37];
assign w5_2 = sdif.sdpara[38];
assign w5_3 = sdif.sdpara[39];
assign w6_0 = sdif.sdpara[40];
assign w6_1 = sdif.sdpara[41];
assign w6_2 = sdif.sdpara[42];
assign w6_3 = sdif.sdpara[43];
assign w7_0 = sdif.sdpara[44];
assign w7_1 = sdif.sdpara[45];
assign w7_2 = sdif.sdpara[46];
assign w7_3 = sdif.sdpara[47];
assign b0 = sdif.sdpara[60];
assign b1 = sdif.sdpara[61];
assign b2 = sdif.sdpara[62];
assign b3 = sdif.sdpara[63];
