...
assign w0_0 = sdif.weight_bias[16];
assign w0_1 = sdif.weight_bias[17];
assign w0_2 = sdif.weight_bias[18];
assign w0_3 = sdif.weight_bias[19];
assign w1_0 = sdif.weight_bias[20];
assign w1_1 = sdif.weight_bias[21];
assign w1_2 = sdif.weight_bias[22];
assign w1_3 = sdif.weight_bias[23];
assign w2_0 = sdif.weight_bias[24];
assign w2_1 = sdif.weight_bias[25];
assign w2_2 = sdif.weight_bias[26];
assign w2_3 = sdif.weight_bias[27];
assign w3_0 = sdif.weight_bias[28];
assign w3_1 = sdif.weight_bias[29];
assign w3_2 = sdif.weight_bias[30];
assign w3_3 = sdif.weight_bias[31];
assign w4_0 = sdif.weight_bias[32];
assign w4_1 = sdif.weight_bias[33];
assign w4_2 = sdif.weight_bias[34];
assign w4_3 = sdif.weight_bias[35];
assign w5_0 = sdif.weight_bias[36];
assign w5_1 = sdif.weight_bias[37];
assign w5_2 = sdif.weight_bias[38];
assign w5_3 = sdif.weight_bias[39];
assign w6_0 = sdif.weight_bias[40];
assign w6_1 = sdif.weight_bias[41];
assign w6_2 = sdif.weight_bias[42];
assign w6_3 = sdif.weight_bias[43];
assign w7_0 = sdif.weight_bias[44];
assign w7_1 = sdif.weight_bias[45];
assign w7_2 = sdif.weight_bias[46];
assign w7_3 = sdif.weight_bias[47];
assign b0 = sdif.weight_bias[60];
assign b1 = sdif.weight_bias[61];
assign b2 = sdif.weight_bias[62];
assign b3 = sdif.weight_bias[63];
