...
create_clock -period 4.000 -name smamgtclk -waveform {0.000 2.000} [get_ports  {fpga\\.AK8}]
#create_clock -period 16.000 -name ethclk -waveform {0.000 8.000} [get_pins qubichw_config/sgmii_ethernet_pcs_pma/bufgtxoutclk/I]
...
create_clock -period 2.000 -name fmc1refclk10 -waveform {0.000 1.000} [get_ports {fpga\\.E10}]
...
create_clock -period 2.000 -name fmc2refclk10 -waveform {0.000 1.000} [get_ports {fpga\\.T8}]
