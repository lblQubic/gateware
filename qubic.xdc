...
create_clock -period 6.000 -name sgmiiclk -waveform {0.000 3.000} [get_ports {fpga\\.AH7}]
...
#create_clock -period 16.000 -name ethclk -waveform {0.000 8.000} [get_pins qubichw_config/sgmii_ethernet_pcs_pma/bufgtxoutclk/I]
create_clock -period 14.000 -name ethclk -waveform {0.000 7.000} [get_pins qubichw_config/sgmii_ethernet_pcs_pma/gig_ethernet_pcs_pma_0/txoutclk]
